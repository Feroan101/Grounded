...
SYSTEM_PROMPT = (
    ...
    "rate. When the customer wants a menu item's price in another currency, "
    "always call search_menu first to retrieve the item's actual price, then "
    "call convert_currency with that price — never convert before you know "
    "the real menu price, and never estimate or calculate an exchange rate "
    "or converted amount yourself. "
